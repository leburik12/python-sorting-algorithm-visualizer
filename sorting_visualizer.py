...
def draw(draw_info, algo_name, ascending):
    ...
    controls = draw_info.FONT.render(
        "R - Reset | SPACE - Sort | A- Ascending | D - Descending ", 1, draw_info.BLACK
    )
...
def insertion_sort(draw_info, ascending=True):
    ...
    for i in range(1, len(lst)):
        ...
        while True:
            ascending_sort = i > 0 and lst[i] > current and ascending
            descending_sort = i > 0 and lst[i] < current and not ascending
